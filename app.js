document.addEventListener("DOMContentLoaded", () => {
    ...
    const cartas = [
        { nombre: "Cheewaca", imagen: "./cartas/cheewaca.jpg" },
        { nombre: "Comando rebelde", imagen: "./cartas/comando rebelde.jpg" },
        { nombre: "Deslizador", imagen: "./cartas/deslizador.jpg" },
        { nombre: "Han Solo", imagen: "./cartas/han solo.jpg" },
        { nombre: "Soldado Explorador", imagen: "./cartas/soldado explorador.jpg" },
        { nombre: "Vader", imagen: "./cartas/vader 2.jpg" },
        { nombre: "Cheewaca", imagen: "./cartas/cheewaca.jpg" },
        { nombre: "Comando rebelde", imagen: "./cartas/comando rebelde.jpg" },
        { nombre: "Deslizador", imagen: "./cartas/deslizador.jpg" },
        { nombre: "Han Solo", imagen: "./cartas/han solo.jpg" },
  ...
  function crearTablero() {
    ...
    cartas.forEach((_, index) => {
      ...
      carta.innerHTML = `
        ...
        <div class="card-front"><img src="cartas/trasera carta.jpg" alt="Card"></div>
